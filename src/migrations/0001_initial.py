# Generated by Django 3.1.2 on 2021-01-11 03:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('registered_by', models.CharField(default='None', max_length=155)),
                ...
                ('identification', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='src.vendoruser')),
            ],
        ),
        migrations.CreateModel(
            name='PatientReport',
            fields=[
                ...
                ('pid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='src.patient')),
            ],
        ),
        migrations.AddField(
            model_name='patient',
            name='service',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='src.vendorservice'),
        ),
        migrations.AddField(
            model_name='patient',
            name='state',
